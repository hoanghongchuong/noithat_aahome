            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center with_dieuhuong">
                  ...
                  <div class="form-group"> 
                    @if($item->noibat>0)
                      <a href="backend/news/edit?id={{$item->id}}&noibat={{ time() }}&type={{ @$_GET['type'] }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Tiêu biểu</a>
                    @else
                      <a href="backend/news/edit?id={{$item->id}}&noibat={{ time() }}&type={{ @$_GET['type'] }}" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Tiêu biểu</a>
                    @endif
                  </div>  
                  @endif 
