        ...
        <div class="box-body">
        	<form method="post" action="backend/newscate/edit?id={{$id}}&type={{ @$_GET['type'] }}" enctype="multipart/form-data">
									...
									<div class="form-group @if ($errors->first('fImagesBg')!='') has-error @endif">
										<div class="form-group">
											<div class="img_backgound">
												<img src="{{ asset('upload/news/'.$data->background) }}" onerror="this.src='{{asset('public/admin_assets/images/no-image.jpg')}}'" width="80px"  alt="NO PHOTO" />
										...
										<label for="file">Chọn ảnh icon</label>
			    ...
			    <div class="col-md-6">
			    	...
			    	<div class="form-group">
					    <label>
				        	<input type="checkbox" name="noibat" {!! (!isset($data->noibat) || $data->noibat==1)?'checked="checked"':'' !!}> Tiêu biểu
				    	</label>
				    </div>
				    @if($_GET['type']=='du-an')
			    	<div class="form-group">
