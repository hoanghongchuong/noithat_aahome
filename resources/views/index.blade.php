...
<head>
    ...
    <link href="{{ asset('public/plugin/fancybox/dist/jquery.fancybox.min.css')}}" rel="stylesheet" />
    <link href="{{ asset('public/css/style.css')}}" rel="stylesheet" />
    <link href="{{ asset('public/css/cus.css')}}" rel="stylesheet" />
...
<script src="{{ asset('public/plugin/isotope/isotope.pkgd.min.js')}}" defer></script>
<script src="{{ asset('public/plugin/masonry/masonry.pkgd.min.js')}}" defer></script>
...
<script src="{{ asset('public/plugin/fancybox/dist/jquery.fancybox.min.js')}}" defer></script>
