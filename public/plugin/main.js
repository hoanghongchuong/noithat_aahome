...
var LightBox = function () {
    var _initInstances = function () {
        ...
        $('._material-item').on('click',function(){
        ...
        $('.slider-for').on('init reInit afterChange', function(event, slick, currentSlide, nextSlide){
            ...
            $('._count._item').text(i + '/' + slick.slideCount);
        });
        ...
        // $('.slider-nav').slick('slickGoTo',instance.id  - 1)
        ...
        $('[data-fancybox="images"]').fancybox({
            ...
            caption: function (instance, item) {
                ...
                title = '<h3 class="_title">' + title + '</h3>';
                caption = '<p>' + caption + '</p>';

                results = title + caption;
...
var Slider = function () {
    ...
    var shopSlider = function () {
        $('[data-slider="material"]').slick({
            nextArrow: '<button  class="vk-btn vk-btn--black-1 vk-arrow next"><i class="ti-angle-right"></i></button>',
            prevArrow: '<button  class="vk-btn vk-btn--black-1 vk-arrow prev"><i class="ti-angle-left"></i></button>',
            // arrows:false,
            slidesToShow: 5,
            slidesToScroll:5,
            autoplay: true,
...
var CustomTheme = function () {
    ...
    var _initInstances = function () {
        var service_item_hover = function(){
            var el = $('.vk-service-item--style-2');

            el.hover(function () {
                    var text = $(this).find('.vk-service-item__text');
                    var button = $(this).find('.vk-service-item__button');
                    text.slideDown('');
                    button.slideDown('');
                    return false;
        ...
        var project_item_hover = function () {
            var el = $('.vk-project-item--style-2');

            el.hover(function () {
                    var text = $(this).find('.vk-project-item__text');
                    var obj = $(this).find('.vk-project-item__wrapper');
                    text.slideDown('');
                    return false;
